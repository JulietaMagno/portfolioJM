...
const ProyectsCard = ({ image, title, text, href}: Props) => {
  ...
  return (
    <div
    onClick={handleFlip}
    className='w-[320px] h-[210px] md:w-[600px] md:h-[380px] rounded-md cursor-pointer pb-3 mb-10'>
        <motion.div
        ...
        >
            ...
            className='w-full h-full group relative flip-card-back bg-cover bg-center text-white rounded-lg p-3'>
                  ...
                  <div className='flex flex-col gap-6 p-2 z-[30]'>
                    ...
                    <button onClick={() => window.open(href, '_blank')} className='bg-gray-300 text-black px-2 py-2 rounded-md hover:bg-white hover:z-[60]'>Check page</button>
                  </div>
            </div>
        </motion.div>
    </div>    
